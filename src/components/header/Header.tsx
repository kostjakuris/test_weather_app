...
const Header = () => {
  ...
  return (
    <Box>
      <Flex className={styles.header__wrapper} justifyContent='space-between' align={'center'} pt={'50px'}>
        <Heading as={'h1'} className={styles.header__title} css={{...titleOne}}>WeatherApp</Heading>
        <form className={styles.header__form} onSubmit={handleSubmit} aria-label={'Form for searching city'}>
          <Flex align={'center'}>
            <Input
              variant={'outline'}
              mr={'20px'}
